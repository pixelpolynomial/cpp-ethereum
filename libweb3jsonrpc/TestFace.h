            ...
            public:
                TestFace()
                {
                    this->bindAndAddMethod(
                        jsonrpc::Procedure("test_closeClient", jsonrpc::PARAMS_BY_POSITION,
                            jsonrpc::JSON_BOOLEAN,  NULL),
                        &dev::rpc::TestFace::test_closeClientI);
                    this->bindAndAddMethod(
                ...
                inline virtual void test_closeClientI(const Json::Value &request, Json::Value &response)
                {
                    (void)request;
                    response = this->test_closeClient();
                }
                ...
                virtual bool test_closeClient() = 0;
